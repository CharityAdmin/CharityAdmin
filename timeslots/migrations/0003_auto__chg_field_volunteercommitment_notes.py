...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VolunteerCommitment.notes'
        db.alter_column(u'timeslots_volunteercommitment', 'notes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'VolunteerCommitment.notes'
        db.alter_column(u'timeslots_volunteercommitment', 'notes', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'timeslots.clientopening': {
            ...
            'startDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 0)'}),
